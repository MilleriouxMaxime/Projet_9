# Generated by Django 5.0.2 on 2025-03-29 12:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='litrevu.ticket', verbose_name='Billet')),
            ],
            options={
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(('user', models.F('followed_user')), _negated=True), name='cannot_follow_self'),
        ),
